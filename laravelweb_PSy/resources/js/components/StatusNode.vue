        ...
        <v-dialog v-model="dialog_createedit" width=750>
            <v-card>
                <v-toolbar dark color="menu">
                    ...
                    <v-toolbar-title v-html='id_data_edit == -1 ?"Tambah Kondisi Lokasi":"Edit Kondisi Lokasi"'></v-toolbar-title>
        ...
        <v-layout row class='bgwhite margintop10'>
            <v-flex xs6>
                <div class='marginleft30 margintop10'>
                    <v-icon class='icontitledatatable'>radio_button_checked</v-icon>
                    <h2 class='titledatatable'>Kondisi Lokasi</h2>
...
export default {
    ...
    methods: {
        ...
        action_change(id,idx_action)
        {
            ...
            {
                this.delete_data(id, ['Riwayat Scan', 'Foto']);
            }
        },
