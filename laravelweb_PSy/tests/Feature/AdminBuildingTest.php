...
class AdminBuildingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testIndex()
    {
        ...
        //2. hit API
        $response = $this->actingAs($user)->getJson('/api/admin/buildings');
    ...
    public function testStore($name, $statusExpected, $jsonExpected)
    {
        ...
        //3. hit API
        $response = $this->actingAs($user)->postJson('/api/admin/buildings', $body);
    ...
    public function storeProvider() {
        ...
        return [
            '1. When name is valid, then return success' => ['Gedung Agape', 200, $successResponseMessage],
    ...
    public function testUpdate($id, $name, $statusExpected, $jsonExpected)
    {
        ...
        //3. hit API
        $response = $this->actingAs($user)->postJson('/api/admin/buildings/' . $id, $body);
    ...
    public function updateProvider() {
        ...
        return [
            '1. When name is valid, then return success' => [1, 'New Gedung Agape', 200, $successResponseMessage],
            '2. When name is empty, then return correct error' => [1, null, 422, $emptyNameResponseMessage],
            '3. When id is invalid, then return correct error' => [999999, 'New Gedung Agape', 400, $invalidBuildingIdResponseMessage],
        ];
    }
    ...
    public function testDelete($id, $statusExpected, $jsonExpected)
    {
        ...
        //2. hit API
        $response = $this->actingAs($user)->deleteJson('/api/admin/buildings/' . $id);
    ...
    public function deleteProvider() {
        ...
        return [
            ...
            '2. When id is invalid, then return correct error' => [999999, 400, $invalidBuildingIdResponseMessage], 
        ];
    }
