...
class AdminStatusNodeTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testIndex()
    {
        ...
        //2. hit API
        $response = $this->actingAs($user)->getJson('/api/admin/status_nodes');
    ...
    public function testStore($name, $statusExpected, $jsonExpected)
    {
        ...
        //3. hit API
        $response = $this->actingAs($user)->postJson('/api/admin/status_nodes', $body);
    ...
    public function storeProvider() {
        ...
        return [
            '1. When name is valid, then return success' => ['Ada maling', 200, $successResponseMessage],
    ...
    public function testUpdate($id, $name, $statusExpected, $jsonExpected)
    {
        ...
        //3. hit API
        $response = $this->actingAs($user)->postJson('/api/admin/status_nodes/' . $id, $body);
    ...
    public function updateProvider() {
        ...
        $invalidStatusNodeIdResponseMessage = [
            "error" => true,
            'code' => 'E-0033',
            "message" => "data not found"
        ];
        return [
            '1. When name is valid, then return success' => [1, 'Ada Maling', 200, $successResponseMessage],
            '2. When name is empty, then return correct error' => [1, null, 422, $emptyNameResponseMessage],
            '3. When id is invalid, then return correct error' => [999999, 'Ada Maling', 400, $invalidStatusNodeIdResponseMessage],
        ];
    }
    ...
    public function testDelete($id, $statusExpected, $jsonExpected)
    {
        ...
        //2. hit API
        $response = $this->actingAs($user)->deleteJson('/api/admin/status_nodes/' . $id);
    ...
    public function deleteProvider() {
        ...
        return [
            ...
            '2. When id is invalid, then return correct error' => [999999, 400, $invalidStatusNodeIdResponseMessage], 
        ];
    }
